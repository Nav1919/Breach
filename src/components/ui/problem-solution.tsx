...
const FeatureCard = ({ title, description }: ProblemCardProps) => (
  <Card className="p-8 bg-[#0a0e17]/90 backdrop-blur-md border-[#1e2330] hover:border-spektr-cyan-50 transition-colors h-[200px] flex flex-col">
    <h3 className="text-2xl font-semibold mb-4 text-spektr-cyan-50">{title}</h3>
    <p className="text-gray-400 text-base leading-relaxed">{description}</p>
  </Card>
);
